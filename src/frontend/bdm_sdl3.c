...
static int sdl3_key_to_panel_button(SDL_Keycode sym, bdm_button_t *out) {
    switch (sym) {
...
static void sdl3_set_panel_button(bdm_input_t *input, sdl_touch_state_t *touch, bdm_core_t *core, bdm_button_t button, int pressed) {
...
static void set_key_button(bdm_input_t *input, SDL_Keycode sym, int pressed, int *quit_requested, bdm_core_t *core, sdl_touch_state_t *touch, const sdl_options_t *opt) {
    ...
    if (sdl3_key_to_panel_button(sym, &panel_button)) {
        sdl3_set_panel_button(input, touch, core, panel_button, pressed);
        return;
    }
    switch (sym) {
    case SDLK_ESCAPE:
